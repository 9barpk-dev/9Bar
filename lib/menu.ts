...
export const menuItems: MenuItem[] = [
  ...
  item("hot-caramel-latte", "Hot Caramel Latte", "Rs 899", "Espresso and steamed milk finished with sweet ribbons of rich caramel.", "/images/coffee/hot-caramel-latte.jpg.png", "Hot Drinks"),
  item("hot-vanilla-latte", "Hot Vanilla Latte", "Rs 899", "Fresh espresso and steamed milk softened with sweet vanilla.", "/images/coffee/hot-vanilla-latte.jpg.png", "Hot Drinks"),
  item("hot-mocha", "Hot Mocha", "Rs 899", "Espresso, steamed milk, and dark chocolate for a rich warming finish.", "/images/coffee/hot-mocha.jpg.png", "Hot Drinks"),
  ...
  item("mocha-frappe", "Mocha Frappe", "Rs 1199", "Ice-blended coffee rich with dark chocolate flavour.", "/images/coffee/mocha-frappe.jpg.png", "Blended Frappes"),
];
